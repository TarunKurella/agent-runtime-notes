---
id: "dsh-note-0286"
title: "SessionTelemetryBackend requires explicit opt-in"
status: "implemented"
class: "feature"
source_commit: "47f943859bef60e4160492346772ded9b24f765a"
source_note: "../02-notes/implemented/feature/2026-08-10-telemetry-default-off.md"
...
search_regex: "(?i)(mode|DSH_TELEMETRY_MODE|DISABLED|@deepseek\\-ai/dsh\\-session\\-telemetry\\-otel|FULL|FEEDBACK_ONLY|DSH_TELEMETRY_DISABLED|cordis\\.yml)"
---

# 0286. SessionTelemetryBackend requires explicit opt-in — implementation context
...
- Tags: `class/feature`, `concern/boundary`, `concern/discovery-routing`, `concern/evidence`, `concern/lifecycle`, `concern/ownership`, `concern/schema-types`, `concern/simplification`, `domain/build-release`, `domain/configuration`, `domain/extensions`, `domain/filesystem`, `domain/llm`, `domain/observability`, `domain/session-state`, `domain/testing`, `lifecycle/implemented`, `mechanism/policy`
- Aliases: `mode`, `env`, `DSH_TELEMETRY_MODE`, `DISABLED`, `@deepseek-ai/dsh-session-telemetry-otel`, `FULL`, `FEEDBACK_ONLY`, `DSH_TELEMETRY_DISABLED`, `cordis.yml`, `dsh-sdk start`, `.env`, `process.env`, `DSH_*`, `DSH_TELEMETRY_MODE=FEEDBACK_ONLY`
- Regex: `(?i)(mode|DSH_TELEMETRY_MODE|DISABLED|@deepseek\-ai/dsh\-session\-telemetry\-otel|FULL|FEEDBACK_ONLY|DSH_TELEMETRY_DISABLED|cordis\.yml)`

```bash
rg -n --pcre2 "(?i)(mode|DSH_TELEMETRY_MODE|DISABLED|@deepseek\\-ai/dsh\\-session\\-telemetry\\-otel|FULL|FEEDBACK_ONLY|DSH_TELEMETRY_DISABLED|cordis\\.yml)" source-deepseek-harness
rg -l --fixed-strings "class/feature" 03-agent-context
```

## Connected notes

- **`source-link`** — [0095. One ordering for configuration sources, and what a discovered file may not decide](0095-one-ordering-for-configuration-sources-and-what-a-discovered-file-may-no.md): The source note links to this decision directly.
...
Generated from the pinned source note and repository tree. The source note remains authority. Context file: `0286-sessiontelemetrybackend-requires-explicit-opt-in.md`.
